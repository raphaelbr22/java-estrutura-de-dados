public class ListaEncadeada<T> {
    ...
    public void add(T conteudo){ //Método que adiciona um novo nó na lista encadeada.
    ...
    public boolean isEmpty(){ //Método que verifica se a lista está vazia (true) ou não (false).
